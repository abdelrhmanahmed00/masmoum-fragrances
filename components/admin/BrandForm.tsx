...
import {
  createBrandAction,
  updateBrandAction,
} from "@/app/admin/(dashboard)/brands/actions";
import { slugify } from "@/lib/slugify";
import FormField from "./FormField";
import { BRAND_ACTION_INITIAL_STATE, type AdminBrandRow } from "@/types/admin-brand";

// Byte-for-byte the same shape as CategoryForm.tsx (slug auto-generation
// UX included) -- see that file's own comment for the full create-vs-edit
  ...
  return (
    <form action={formAction} className="max-w-xl space-y-5">
      ...
      <FormField
        ...
        hint="Not shown publicly yet in this phase. Lowercase letters, numbers, and hyphens only."
      />
