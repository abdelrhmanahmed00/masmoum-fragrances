...
-- Generated convenience concatenation of supabase/migrations/0001..0012 for
-- pasting into the Supabase SQL Editor in a single run (fresh database only —
-- if 0001-0011 already ran, only paste 0012 to add storage buckets +
-- hero_slides). Canonical source of truth: the individual files in
-- supabase/migrations/.
-- ===========================================================================
