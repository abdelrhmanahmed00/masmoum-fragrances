...
-- Generated convenience concatenation of supabase/migrations/0001..0013 for
-- pasting into the Supabase SQL Editor in a single run (fresh database only —
-- if 0001-0012 already ran, only paste 0013 to add home-videos storage +
-- home_videos). Canonical source of truth: the individual files in
-- supabase/migrations/.
-- ===========================================================================
...
-- ---------------------------------------------------------------------------
-- migrations/0012_storage_and_hero_slides.sql
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- migrations/0013_home_videos.sql
-- ---------------------------------------------------------------------------
