...
-- Generated convenience concatenation of supabase/migrations/0001..0010 for
-- pasting into the Supabase SQL Editor in a single run (fresh database only —
-- if 0001-0009 already ran, only paste 0010 to add the missing service_role
-- grants). Canonical source of truth: the individual files in
-- supabase/migrations/.
-- ===========================================================================
